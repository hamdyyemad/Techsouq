...
export default function SellerProductsGallery() {
  ...
  return (
    <div className="xs:min-w-full bg-gray-100 min-w-max h-screen	dark:bg-[#151725] ">
      <div className="min-w-fit container mx-auto  px-5 h-screen dark:bg-[#151725] xs:p-0">
        <div className="md:flex no-wrap md:-mx-2 dark:bg-[#151725] xs:m-0">
          {/* <!-- Right Side --> */}
          <div className="px-3 mx-2 h-screen dark:bg-[#151725] xs:p-0 xs:m-0">
...
function SellerProducts({ product }) {
  ...
  return (
    <>
      <div className="w-fit mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-4 mt-10 mb-5 dark:bg-[#151725] xs:gap-x-0 xs:w-max xs:mx-0 xs:p-0">
        {product?.map((p) => {
          return (
            <EcommerceCard
              key={p._id}
